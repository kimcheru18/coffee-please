...
function displayCoffeeTypes(coffeeArray) {
    ...
    $.each(coffeeArray, function (coffeeArrayKey, coffeeArrayValue) {
        buildTheHtmlOutput += "<li class='slide_open' onclick=updateSlideContent('" + coffeeArrayValue.coffeeName + '_' + coffeeArrayValue.coffeeLocation + "')>";
